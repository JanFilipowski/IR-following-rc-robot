...
static constexpr uint8_t PIN_LEFT_FWD  = 8;
static constexpr uint8_t PIN_LEFT_REV  = 5;
static constexpr uint8_t PIN_RIGHT_REV = 6; 
static constexpr uint8_t PIN_RIGHT_FWD = 7;
static constexpr uint8_t PIN_MODE      = 2;   // toggle MANUAL/AUTO
static constexpr uint8_t PIN_BTN_A1    = 3;
static constexpr uint8_t PIN_BTN_A2    = 4;
...
void setup() {
  ...
  if (!radio.begin()) {
    Serial.println("Blad: rejdio nie odpowiada");
    while (true) {}
  }
